        ...
        <div className='flex justify-between items-center w-full h-full px-7 2xl:px-16'>
            ...
            <div>
                <ul className='hidden md:flex '>
                    ...
                    <Link href='/'>
                        <li className='font-bold ml-10 text-md uppercase hover:border-b'>Home</li>
                    </Link>
                    <Link href='/'>
                        <li className='font-bold ml-10 text-md uppercase hover:border-b'>About</li>
                    </Link>
                    <Link href='/'>
                        <li className='font-bold ml-10 text-md uppercase hover:border-b'>Skills</li>
                    </Link>
                    <Link href='/'>
                        <li className='font-bold ml-10 text-md uppercase hover:border-b'>Projects</li>
                    </Link>
                    <Link href='/'>
                        <li className='font-bold ml-10 text-md uppercase hover:border-b'>Contact</li>
                    </Link>
                </ul>
